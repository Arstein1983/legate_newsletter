...
ADMIN_TG_ID = 142373108  # <-- ваш Telegram user id из ADMIN_IDS

async def main():
    s = get_settings()
    SESSIONS_DIR.mkdir(exist_ok=True)
    path = SESSIONS_DIR / f'admin_{ADMIN_TG_ID}'
    client = TelegramClient(str(path), s.telegram_api_id, s.telegram_api_hash)
